<template>
  <div
    class="w-full h-full border-solid border-8 border-night light:text-night text-sm"
  >
    <div class="px-8 py-2 sm:p-10 max-h-screen w-full">
      ...
      >
        ...
        <div class="px-6">
          <h2
            class="font-display tracking-widest text-xl sm:text-4xl font-bold"
          >
            hi!
          </h2>
          <br />
